  ...
  <div class="navbar">
    ...
    <div class="navbar-right-container" style="display: flex;">
      <div class="navbar-menu-container">
        ...
        <a href="javascript:void(0)" class="navbar-link" @click="logOut" v-if="loginFlag">Log Out</a>
    ...
    <div class="md-modal modal-msg md-modal-transition" :class="{'md-show':loginModelFlag}">
      <div class="md-modal-inner">
        <div class="md-title" @click="loginModelFlag=true">Login in</div>
          ...
          <div class="confirm-tips">
            ...
            <ul>
              <li class="regi_form_input">
                ...
                <input type="text" tabindex="1" name="loginname" v-model="userName" class="regi_login_input regi_login_input" placeholder="User Name">
              </li>
...
<script>
  ...
  export default {
    ...
    computed:{
      ...mapState(['nickName','cartCount'])//展开运算符 封装状态的返回值
      /*nickName() {
